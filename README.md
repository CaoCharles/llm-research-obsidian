...
GitHub Actions 會在每週一 **08:00（Asia/Taipei）** 執行 `.github/workflows/daily.yml`（原本每天執行，為了節省 OpenAI API 費用改為每週一次）：
...
|---|---|---|
| Daily paper digest | 每週一 08:00 | `main` 摘要 commit 與 Pages 部署 |
